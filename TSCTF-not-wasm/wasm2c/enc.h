#ifndef ENC_H_GENERATED_
#define ENC_H_GENERATED_
#ifdef __cplusplus
extern "C" {
#endif
...
/* export: 'check' */
extern u32 (*WASM_RT_ADD_PREFIX(Z_checkZ_iv))(void);
/* export: 'inp' */
extern u32 (*WASM_RT_ADD_PREFIX(Z_inpZ_i));
/* export: '_initialize' */
